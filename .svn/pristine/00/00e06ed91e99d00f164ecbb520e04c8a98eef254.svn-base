    		...
    		<form id="form" method="post" >  
                    <table cellpadding="80px">  
                        <tr style="height: 50px">  
                            ...
                            <input  id="name" class="easyui-textbox" name="name"  style="width: 200px"  />
                            </td>  
                        </tr> 
                        ...
                        <tr style="height: 50px">  
                           <td style="width: 200px;text-align: right;background-color:#fafafa ">父类:</td>  
                            <td >
                            <select id="parent" class="easyui-combobox" name="parent_id" style="width: 172px;">  
                             </select>  
                             </td>  
                        </tr>  
                         ...
                         <tr style="height: 50px">  
                            ...
                            <td ><input class="easyui-textbox" type="text" name="description" style="width: 200px;"></input></td>  
                        </tr> 
                        <tr style="height: 50px">  
...
<script type="text/javascript">
			...
			$(function(){
	    		...
	    		$("#saveBtn").on("click",function(){
					...
					$.post("system/product/saveCategory",$("#form").serialize(),function(data){				
						if(data.b){
							$.messager.alert({
			           			title:"提示",
			           			msg:data.message,
