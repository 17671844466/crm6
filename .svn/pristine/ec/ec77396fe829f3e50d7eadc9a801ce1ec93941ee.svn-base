...
<form id="form" method="post">  
   ...
   <!-- 第一行 -->
       <tr style="height: 50px">  
          ...
          <td style="width: 100px;text-align: right;background-color:#fafafa ">用户名:</td>  
          <td style="width: 200px;">
          <input class="easyui-textbox" type="text" name="rolename" value="${user2.username }" style="width: 200px"/>
          </td>  
     	<td style="width: 100px;text-align: right;background-color:#fafafa ">用户状态:</td> 
     	<td>
      ...
      <!-- 第二行 -->
        ...
        <input name="role" value="${li.id }" type="checkbox" style="font-size:40px;"> ${li.rolename }</input>
        &nbsp  &nbsp
     ...
     <input name="id" type="hidden" value="${user2.id }" /> 
...
$(function(){
	...
	$("#parentid").combobox('setValue','${user2.state}');
