...
<div id="addLeads" class="easyui-panel" title="转化线索"
    style="width:100%;height:100%;padding:10px;background-color:white;" >
    		...
    		<input type="text" hidden value="${requestScope.customer.id} " name="leadsId"/>
                    ...
                    <tr style="height:30px;"><td style="font-weight:bold;">主要信息</td></tr>
                        <tr style="height: 40px">  
                            ...
                            <td style="width: 250px;"><input class="easyui-textbox" type="text" name="name" value="${requestScope.ownerUser }" style="width: 200px"/></td>  
                       		...
                       		<td><input class="easyui-textbox" type="text" name="customer.name" value="${requestScope.customer.name }" data-options="required:true" style="width: 200px"></input></td>
                        </tr>  
                        <tr style="height: 40px">  
                       ...
                       <td colspan="4" style="font-weight:bold;">首要联系人信息</td></tr>
                        <tr style="height: 40px">  
                            ...
                            <td colspan="2"><input class="easyui-textbox" value="${requestScope.customer.contactsName }" type="text" name="contacts.name" style="width: 200px"></input></td>  
                       		<td style="width: 200px;text-align: right;background-color:#fafafa ">称呼:</td> 
                            <td ><input class="easyui-textbox" type="text" value="${requestScope.customer.saltname }" name="contacts.saltname"  style="width: 200px"></input></td> 
                        </tr>
                        <tr style="height: 40px">  
                            <td style="width: 200px;text-align: right;background-color:#fafafa ">邮箱:</td> 
                            <td colspan="2"><input class="easyui-textbox" value="${requestScope.customer.email }" type="text" name="contacts.email" style="width: 200px"></input></td>  
                       		<td style="width: 200px;text-align: right;background-color:#fafafa ">职位:</td> 
                            <td ><input class="easyui-textbox" type="text" value="${requestScope.customer.position }" name="contacts.post"  style="width: 200px"></input></td> 
                        </tr> 
                        <tr style="height: 40px">  
                            ...
                            <td ><input class="easyui-textbox" type="text" value="${requestScope.customer.mobile  }" name="contacts.telephone"  style="width: 200px"></input></td> 
                        </tr> 
                        <tr style="height: 40px">  
                            <td style="width: 200px;text-align: right;background-color:#fafafa ">备注:</td> 
                            <td colspan="4"><textarea rows="5" cols="100" name="contacts.description" >${requestScope.customer.leadnote }
                            </textarea></td>  
                        </tr> 
                        <tr style="height: 40px">  
...
<script type="text/javascript">
			$(function(){
				$("#origin").combobox('setValue','${requestScope.customer.source }');
			...
			$(function(){
	    		...
	    		$("#saveBtn").on("click",function(){
					...
					$.post("system/leads/doConversion",$("#form").serialize(),function(data){				
						if(data.success){
