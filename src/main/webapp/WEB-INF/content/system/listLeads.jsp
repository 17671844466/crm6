	...
	<div id="tabs" data-options="region:'center',border:false,height:800" class="easyui-tabs">
		...
		<div id="tab1" title="线索">
				<div class="theme-user-info-panel">
					...
					<a   id="mydown" style="margin-left: 20px;font-size: 15px">下属负责的</a>&nbsp;&nbsp;|&nbsp;&nbsp;
			...
			<div id="toolbar2" class="right" style="margin-left: 10px;">
				 <span class="dropdown-option" >
		...
		//searchMy
			...
			//mydown
				...
				$("#mydown").on('click',function(){
					doSearch("condition[deleteStatus]=0&condition[mydown]=${sessionScope.user.id}");
					});	
