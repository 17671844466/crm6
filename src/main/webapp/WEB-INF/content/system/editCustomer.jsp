...
<div id="master-layout" style="height: 100%;width: 100%">
    		...
    		<input type="text" hidden value="${customer.id }" name="customer.id"/>
    		<input type="text" hidden value="${customer.contid }" name="contacts.id"/>
    		<input type="text" hidden value="${customer.create_time }" name="customer.createTime"/>
    		<input type="text" hidden value="${customer.creator_user_id }" name="customer.creatorUserId"/>
    		<input type="text" hidden value="${customer.creatoruserid }" name="contacts.creatorUserId"/>
    		<input type="text" hidden value="${customer.create_time }" name="contacts.createTime"/>
                    ...
                    <tr style="height:30px;"><td style="font-weight:bold;">主要信息</td></tr>
                        <tr style="height: 40px">  
                            ...
                            <td style="width: 250px;"><input class="easyui-textbox" type="text" name="name" value="${customer.owner_user}" style="width: 200px"/></td>  
                       		<td style="width: 200px;"><input type="button" value="放入客户池" class="easyui-linkbutton" style="width: 100px;height: 30px" style="width: 200px"/></td>
                       		<td style="width: 200px;text-align: right;background-color:#fafafa ">客户名称:</td> 
                       		<td><input class="easyui-textbox" type="text" name="customer.name" value="${customer.name}" data-options="required:true" style="width: 200px"></input></td>
                        </tr>  
                        <tr style="height: 40px">  
                           <td style="width: 200px;text-align: right;background-color:#fafafa ">客户行业:</td>  
                            <td colspan="2"><select class="easyui-combobox" id="industry" name="customer.industry" style="width: 200px;">  
                             ...
                             <td colspan="2"><select id="origin" class="easyui-combobox" name="customer.origin" style="width: 200px;">  
                           			<option value="0">--请选择--</option> 
                        ...
                        <tr style="height: 40px">  
                            ...
                            <input class="" type="radio" name="customer.ownership"  style="width: 30px" value="国企"/>国企
                            <input class="" type="radio" name="customer.ownership"  style="width: 30px" value="民营" />民营</td> 
                       		<td style="width: 200px;text-align: right;background-color:#fafafa ">邮编:</td> 
                       		<td><input style="width:200px;" name="customer.zipCode" type="text" value="${customer.zip_code}" class="easyui-textbox"/>
                             </td>  
                        </tr>  
                        <tr style="height: 40px">  
                       ...
                       <tr style="height: 40px;" >  
                            ...
                            <td colspan="4">
                            	<div data-toggle="distpicker" style="display: inline;" data-province="${customer.province }" data-city="${customer.city }" data-district="${customer.district }">
	                            	...
	                            	<input class="easyui-textbox" type="text" value="${customer.road }" name="road"/>
                            	</div>
                            </td> 
                       ...
                       <td colspan="4" style="font-weight:bold;">首要联系人信息</td></tr>
                        <tr style="height: 40px">  
                            ...
                            <td colspan="2"><input class="easyui-textbox" value="${customer.contact}" type="text" name="contacts.name" style="width: 200px"></input></td>  
                       		<td style="width: 200px;text-align: right;background-color:#fafafa ">称呼:</td> 
                            <td ><input class="easyui-textbox" type="text" value="${customer.saltname }" name="contacts.saltname"  style="width: 200px"></input></td> 
                        </tr>
                        <tr style="height: 40px">  
                            <td style="width: 200px;text-align: right;background-color:#fafafa ">邮箱:</td> 
                            <td colspan="2"><input class="easyui-textbox" value="${customer.email}" type="text" name="contacts.email" style="width: 200px"></input></td>  
                       		<td style="width: 200px;text-align: right;background-color:#fafafa ">职位:</td> 
                            <td ><input class="easyui-textbox" type="text" value="${customer.post }" name="contacts.post"  style="width: 200px"></input></td> 
                        </tr> 
                        <tr style="height: 40px">  
                            <td style="width: 200px;text-align: right;background-color:#fafafa ">QQ:</td> 
                            <td colspan="2"><input class="easyui-textbox" type="text" value="${customer.qq_no }" name="contacts.qqNo" style="width: 200px"></input></td>  
                       		<td style="width: 200px;text-align: right;background-color:#fafafa ">手机:</td> 
                            <td ><input class="easyui-textbox" type="text" value="${customer.telephone }" name="contacts.telephone"  style="width: 200px"></input></td> 
                        </tr> 
                        <tr style="height: 40px">  
                            <td style="width: 200px;text-align: right;background-color:#fafafa ">备注:</td> 
                            <td colspan="4"><textarea rows="5" cols="100" name="contacts.description" >${customer.description}
                            </textarea></td>  
                        </tr> 
                        <tr style="height: 40px">  
...
<script type="text/javascript">
			$(function(){
				$("#industry").combobox('setValue','${customer.industry}');
				$("#origin").combobox('setValue','${customer.origin}');
				$("input[value='${customer.ownership}']").prop("checked",true);
				$("input[value='${customer.rating}']").prop("checked",true);

				
				$("#saveBtn").on("click",function(){
					$.post("system/customer/updateCustomer",$("#form").serialize(),function(data){				
						if(data.success){
